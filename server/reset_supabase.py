#!/usr/bin/env python3
"""
Reset Supabase database and migrate SQLite data
This will DELETE all existing data and recreate with SQLite data
"""
...
def clear_supabase_data(supabase: Client):
    """Clear all existing data from Supabase tables"""
    print("🗑️  Clearing existing Supabase data...")
    
    tables = ['messages', 'conversations', 'personas', 'language_dashboards', 'users']
...
def main():
    ...
    print("🚀 Starting FULL RESET and migration from SQLite to Supabase...")
    print("⚠️  WARNING: This will DELETE ALL existing data in Supabase!")
    ...
    try:
        ...
        print(f"\n🎉 Full reset and migration completed successfully!")
        print(f"📊 Total records migrated: {total_migrated}")
        print(f"🗑️  All previous Supabase data has been replaced")
